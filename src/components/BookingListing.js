        ...
        <div className='flex flex-col w-full lg:w-1/2'>
          ...
          <div className='w-full flex px-4 lg:px-8 justify-center lg:justify-start items-start py-4'>
            <section className='flex flex-col items-center lg:items-start'>
              ...
              <span className='text-sm lg:text-basec text-slate-500 font-medium'>{departureairpot}</span>
              <span className='text-sm lg:text-basec text-slate-500 font-medium h-2'>{departureterminal}</span>
            ...
            <section className='flex flex-col  items-center lg:items-start pl-4'>
              ...
              <span className='text-sm lg:text-basec text-slate-500 font-medium'>{arrivalairpot}</span>
              <span className='text-sm lg:text-basec text-slate-500 font-medium h-2'>{arrivalterminal}</span>
              <div className='flex flex-col my-4'>
